...
- The popover dropdown uses c9watch styling instead of the system menu, supports keyboard navigation and outside-click dismissal, and keeps its trigger borderless when focused.
